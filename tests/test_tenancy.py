...
def test_same_tenant_reference_is_allowed_and_cross_tenant_fails_closed() -> None:
    context = TenantContext(tenant_id="acme-001", subject="user-alice", source="oidc_claim")
    own = TenantScopedReference(tenant_id="acme-001", object_type="identity", object_id="alice")
